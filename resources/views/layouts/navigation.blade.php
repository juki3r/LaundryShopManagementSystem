    ...
    <div class="flex flex-col mt-5 justify-start">
        <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" class="  mb-2">
            <div class="flex items-center">
                ...
                <span class="mx-1" style="font-size: 14px; color:black !important">{{ __('Dashboard') }}</span>
            </div>
        </x-nav-link>
        <!-- Orders Nav Link -->
        <x-nav-link :href="route('show.customers')" :active="request()->routeIs('show.customers')" class="mb-2">
            <div class="flex items-center">
                ...
                <span class="mx-1" style="font-size: 14px">{{ __('Customers') }}</span>
            </div>
        </x-nav-link>

        <!-- Orders Nav Link -->
        <x-nav-link :href="route('orders.index')" :active="request()->routeIs('orders.*')" class="mb-2">
            <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <x-nav-link :href="route('show.riders')" :active="request()->routeIs('show.riders')" class="mb-2">
            <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <span class="mx-1" style="font-size: 14px">{{ __('Riders') }}</span>
            </div>
        </x-nav-link>

        <!-- Reports Nav Link -->
        <x-nav-link :href="route('reports.index')" :active="request()->routeIs('reports.*')" class="mb-2">
            <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <span class="mx-1" style="font-size: 14px">{{ __('Reports') }}</span>
            </div>
        </x-nav-link>

        <!-- Reports Nav Link -->
        <x-nav-link :href="route('feedbacks.index')" :active="request()->routeIs('feedbacks.*')" class="mb-2">
            <div class="flex items-center">
                <svg class="w-5 h-5 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none"
                    viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <span class="mx-1" style="font-size: 14px">{{ __('Feedbacks') }}</span>
            </div>
        </x-nav-link>
    </div>
    @endif
